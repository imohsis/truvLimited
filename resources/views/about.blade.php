...
<html class="no-js">
    <head>
        ...
        <title>About Us | Tru V Limited</title>
                            ...
                            <div class="row">
                                <div class="col-md-12" data-appear-animation="fadeIn" data-appear-animation-delay=".2">
                                    ...
                                    <p class="col-md-10 col-md-offset-1 big">In order to achieve this, it is affiliated with various estate companies which will ease the provision of housing facilities to its participants.
                                        Being the first of its kind to provide <strong>"JOB OPPORTUNITIES"</strong> to its participants at <strong>'A STAGE"</strong> in the scheme.It provides easy access to business start up capital with ease.It provide employment opportunities through the Keke Napep/Bike Scheme. It focuses on solving food inadequacies by providing food items to ease recession and economic crisis at every stage(s) and level(s) in the Scheme.It provides employment opportunities and makes you self dependent - tailored at eradicating <strong>DEPENDENT SPIRIT</strong>.It is also aimed at providing <strong>"LOW COST HOUSING"</strong> and improve the standard of living nationwide for Nigerian residents.</p>
