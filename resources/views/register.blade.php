                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4 col-xs-12 ">
                                    <a href="{{ url('/kekeownershipsignup') }}" class="btn btn-primary float-righter font-2x bg-gradient-blue"><span>Keke Napep Ownership Scheme</span><span class='visible-xs'>&nbsp;&nbsp;</span></a>
