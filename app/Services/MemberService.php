...
class MemberService {
    ...
    public function getMemberById($id, $code) {
        $member = \DB::table('Members')->select('Members.id', 'full_name', 'phone', 'email', 'location', 'Members.approved_by', 'teller_id','transaction_id','member_id','Members.approved_status')
